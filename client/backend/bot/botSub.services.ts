...
export const BotSubService = {
  ...
  async updateBotSub(botSubId: string, payload: BotUpdateRequest) {
  ...
  async getAllSubscriptions(params: SubscriptionFilterParams) {
  ...
  async toggleBotSubscriptionStatus(subscriptionId: string, enable: boolean) {
