...
import { InitialStatusSection } from "./_components/InitialStatusSection";
import { useRouter } from "next/navigation";
import { RiskLevel, TradeType } from "@/entities/mockAdminAiBots";

interface Props {
  //   onBack: () => void;
}

export default function AdminBotCreatePage({}: Props) {
  // All state here
