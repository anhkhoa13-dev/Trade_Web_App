  ...
  "outline-none transition-[color,box-shadow]",
  {
    variants: {
      variant: {
        ...
        link:
          "bg-transparent " +
          "hover:text-primary hover:bg-transparent focus:text-primary focus:bg-transparent data-[state=true]:underline " +
...
function NavigationMenuTrigger({
  ...
  children,
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Trigger> & { variant?: "default" | "link" }) {
  return (
    ...
    variants: {
      variant: {
        ...
        link:
          ...
          "data-[active=true]:underline data-[active=true]:text-primary " +
          "focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
      },
    },
    defaultVariants: {
